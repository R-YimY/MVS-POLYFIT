...
FT Image_edge_simplify::max_distance(std::vector<Point> p, Otr_2 &otr2)
{
...
std::vector<vec3> Image_edge_simplify::edge_simplify(std::vector<std::vector<int>> edge_point,
...
std::vector<vec3> Image_edge_simplify::cluster_lines(Otr_2 &otr2, Map::Facet *foot_print, int &width)
{
    std::vector<Point> points;
