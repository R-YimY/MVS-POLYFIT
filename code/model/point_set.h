...
public:
	...
	std::vector<double>& planar_qualities() { return planar_qualities_; }
	std::vector<double>& images() { return images_; }
	...
	const std::vector<double>& planar_qualities() const { return planar_qualities_; }
	const std::vector<double>& images() const { return images_; }
	...
	bool 	has_images() const { return images_.size() > 0 && images_.size() == points_.size(); }
